  ...
  return (
      <section className="home_tiers mt-19">
        <div className="container !max-w-[1380px]">
          ...
          <h2 data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="0" className="text-3xl md:text-4xl lg:text-big font-semibold text-center mb-5 text-golden">Investment Tiers
          </h2>
          <p data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="0" className="sub_text texl-lg lg:text-2xl text-center">Limited time offer - 30% discount. Secure your spot before rates increase.</p>
          ...
          <div className="tiers_wrap flex flex-col md:flex-row md:flex-wrap gap-12 lg:gap-4 items-center justify-center mt-11 lg:mt-24">
            ...
            <div data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="0" className="tier flex-1 bg-[#D9D9D9]/10 rounded-[10px] flex flex-col items-center p-7">
            ...
            <div data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="300" className="tier flex-1 bg-[#D9D9D9]/10 rounded-[10px] flex flex-col items-center p-7 relative">
            ...
            <div data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="600" className="tier flex-1 bg-[#D9D9D9]/10 rounded-[10px] flex flex-col items-center p-7">
            ...
            <div data-aos="fade-up" data-aos-offset="200"  data-aos-duration="700" data-aos-delay="900" className="tier flex-1 bg-[#D9D9D9]/10 rounded-[10px] flex flex-col items-center p-7">
