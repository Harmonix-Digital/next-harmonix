...
const DemoPage = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch("/api/agents/kairos", {
        method: "POST",
            ...
            <div className="chat_box w-full border-l border-[#D9D9D9]/30">
              ...
              <div className="agent_top flex flex-col items-center md:flex-row justify-between  gap-9 border-b border-[#D9D9D9]/30">
                <div className="image_col">
                  <Image src="/images/agent-kairos.png" alt="Agent Icon" width={80} height={80} />
                </div>
                
                <div className="desc_col text-white flex-1">
                  <h3 className='font-bold text-2xl mb-2 text-center md:text-left'>KAIROS</h3>
