...
const DemoPage = () => {
  ...
  //   const res = await fetch("/api/agents/sol", {
  //     method: "POST",
  //     headers: { "Content-Type": "application/json" },
  //     body: JSON.stringify({ input_as_text: input }), // <-- fixed
  //   })

  //   const data = await res.json()

  //   setMessages((prev) => [...prev, { from: "agent", text: data.output_text }]) // <-- fixed
  //   setInput("")
  // }
          ...
          <div className="single_agent relative mt-6">
            ...
            {/* <div className="agent_top flex flex-col items-center md:flex-row justify-between  gap-9">
              <div className="image_col">
                <Image src="/images/agent-sol.png" alt="Agent Icon" width={80} height={80} />
              </div>
              
              <div className="desc_col text-white flex-1">
                <h3 className='font-bold text-2xl mb-2 text-center md:text-left'>SOL</h3>
